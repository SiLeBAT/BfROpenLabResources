...
\begin{frame}
	\begin{itemize}
		...
		\item In FoodChain-Lab it is also possible to import the whole delivery network from one Excel file, but the procedure is not documented here. The "All In One" template can be downloaded from here: \url{https://github.com/SiLeBAT/BfROpenLabResources/raw/master/GitHubPages/templates/All_In_One_Template.xlsx}.
	\end{itemize}
\end{frame}
...
\begin{frame}
	...
	\begin{itemize}
		...
		\item In the \textbf{Products Out} table all deliveries to "Caterer 1" are listed.
...
\begin{frame}
	...
	\begin{itemize}
		...
		\item Here you can enter the deliveries received by "Caterer 1", that were used as ingredients in the defined lots.
		\item Enter all information for the delivery of "Frozen Strawberries" from "Frozen Fruit Sales" as you can see in the screenshot.
	\end{itemize}
\end{frame}
...
\begin{frame}
	...
	\begin{itemize}
		\item Now switch to the \textbf{BackTracing} sheet.
		\item Enter the two deliveries from the screenshot into the \textbf{Ingredients for Lot(s)} table.
	\end{itemize}
\end{frame}
...
\begin{frame}
	...
	\end{center}
	\begin{itemize}
		\item To import the two files into the database click on the \textbf{Table import} button in the upper left corner of the database dialog.
	\end{itemize}
\end{frame}
