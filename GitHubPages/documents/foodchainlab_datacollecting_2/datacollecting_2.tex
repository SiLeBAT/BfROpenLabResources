...
\begin{frame}
	\begin{itemize}
		...
		\item You can either complete part 1 of the tutorial or directly import the following files into a new or reset database before starting this tutorial.
...
\begin{frame}
	...
	\begin{itemize}
		...
		\item Save the completed document as e.g. "Backtrace\_request\_Frozen Fruit Sales_completed.xlsx".
	\end{itemize}
\end{frame}
...
\begin{frame}
	...
	\end{center}
	\begin{itemize}
		\item In the file dialog that appears, select "Backtrace\_request\_Frozen Fruit Sales_completed.xlsx" and press \textbf{Open}.
	\end{itemize}
\end{frame}
...
\begin{frame}
	...
	\begin{itemize}
		...
		\item Save the completed document as e.g. "StationFwdtrace\_request\_Caterer 3_completed.xlsx".
	\end{itemize}
\end{frame}
...
\begin{frame}
	...
	\end{center}
	\begin{itemize}
		\item In the file dialog that appears, select "StationFwdtrace\_request\_Caterer 3_completed.xlsx" and press \textbf{Open}.
	\end{itemize}
\end{frame}
