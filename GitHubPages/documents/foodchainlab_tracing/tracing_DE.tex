...
\begin{frame}
	\begin{itemize}
		...
		\item Lassen Sie sich im \textbf{Tracing View} den Forward- und Backward-Trace von der Station zeigen, die an die beiden schwarzen Stationen liefert.
...
\begin{frame}
	...
	\begin{itemize}
		...
		\item Zwei der drei Ausbruchs-Stationen haben nun orange Streifen. Das bedeutet, dass Sie auch auf dem Forward-Trace sind.
	\end{itemize}
\end{frame}
...
\begin{frame}
	...
	\begin{itemize}
		...
		\item Nun kann die ganz linke Ausbruchs-Station nicht mehr erreicht werden (keine orangen Streifen mehr).
	\end{itemize}
\end{frame}
