...
\begin{frame}
	\begin{itemize}
		...
		\item Lassen Sie sich im \textbf{Tracing View} den Forward- und Backward-Trace von der Station zeigen, die an die beiden Stationen mit Kreuzkontamination (schwarz) liefert.
